...
echo "Windows 10 x64 Lite On Google Cloud Shell"
...
echo "================================"
cpu=$(echo nproc | bash)
sudo qemu-system-x86_64 -vnc :0 -hda lite10.qcow2  -smp cores=$cpu  -m 12288M -machine usb=on -device usb-tablet > /dev/null 2>&1